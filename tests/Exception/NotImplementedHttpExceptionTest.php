...
use Exception;
use HttpSoft\Basis\Exception\NotImplementedHttpException;
...
class NotImplementedHttpExceptionTest extends TestCase
{
    ...
    {
        $this->statusCode = ErrorResponseGeneratorInterface::STATUS_NOT_IMPLEMENTED;
    ...
    public function testBadRequestHttpExceptionWithReasonPhrase()
    {
        ...
        $exception = new NotImplementedHttpException($reasonPhrase);
    ...
    public function testHttpExceptionWithReasonPhraseAndWithPrevious()
    {
        ...
        $exception = new NotImplementedHttpException('', $previous);
